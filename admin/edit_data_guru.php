...
<body bgcolor="f0f0f0">
    ...
    <div class="container bg-light shadow p-3 mb-5">
        <div class="alert alert-info">
            <center><b>EDIT DATA GURU</b></center>
        </div>
            ...
            <form method="post" class="form-group">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td> : </td>
                        <td width="500"><input type="text" name="id_alternatif" value="<?= $data['id_alternatif']; ?>"
                                readonly class="form-control" autocomplete="off"></td>
                    </tr>

                    <tr>
                        <td><label>Nama Alternatif</label></td>
                        <td> : </td>
                        <td width="500"> <input type="text" name="nama_alternatif" value="<?= $data['nama']; ?>"
                    ...
                    <?php foreach ($data_kriteria as $kriteria) { ?>
                        <tr>
                            ...
                            <td> : </td>
                            <td width="500">
                                <!-- Menambahkan label keterangan untuk kriteria 1 -->
                                ...
                                <!-- Menambahkan label keterangan untuk kriteria 2 -->
                                ...
                                <?php } elseif ($kriteria['id_kriteria'] == 4) { ?>
                                    <select name="c<?= $kriteria['id_kriteria'] ?>" class="form-control">
    ...
    <script src="http://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/js/bootstrap.min.js"
